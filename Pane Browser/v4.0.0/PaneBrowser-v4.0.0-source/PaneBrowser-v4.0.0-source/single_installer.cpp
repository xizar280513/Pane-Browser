...
int WINAPI wWinMain(HINSTANCE, HINSTANCE, PWSTR cmd, int) {
    ...
    MessageBoxW(nullptr,shortcutsOk?L"Pane Browser v4.0.0 was installed or upgraded. Shortcuts were updated.":L"Pane Browser v4.0.0 was installed or upgraded, but one or more shortcuts could not be created.",L"Pane Browser Setup",MB_OK|(shortcutsOk?MB_ICONINFORMATION:MB_ICONWARNING)); CoUninitialize(); return 0;
}
