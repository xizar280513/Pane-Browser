...
"$CXX" -std=c++17 -O2 -municode -mwindows -static-libgcc -static-libstdc++ -I "$ROOT" -I "$SDK/include" PaneBrowser.cpp PaneBrowser-res.o "$SDK/x64/WebView2Loader.dll.lib" -lole32 -luuid -luser32 -lgdi32 -lshell32 -lcomctl32 -ladvapi32 -lshlwapi -o PaneBrowserCore.exe
...
printf 'Built v2.0.0 artifacts in %s\n' "$ROOT"
